...
public class SortingAlgorithmsTest {
    ...
    public void testRandomInsertionSort() throws Exception {
        testSortingMethodTimes(new OurInsertionSorting(), COUNT);
    }

    @Test
    public void testRandomQuickSort() throws Exception {
        testSortingMethodTimes(new OurQuickSorting(), COUNT);
    }

    @Test
    public void testRandomShellSort() throws Exception {
        testSortingMethodTimes(new OurShellSorting(), COUNT);
    }

    @Test
    public void testRandomMergeSort() throws Exception {
        testSortingMethodTimes(new OurMergeSorting(), COUNT);
    }
